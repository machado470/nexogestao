...
- **P1:** completar OpenAPI para futura geração de contratos; cobrir rotas administrativas ainda ausentes da matriz multi-tenant; observabilidade dos fallbacks de WhatsApp, Queue e Billing; definição operacional de produção.
